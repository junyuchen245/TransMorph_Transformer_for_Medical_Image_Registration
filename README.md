...
<img src="https://raw.githubusercontent.com/iampavangandhi/iampavangandhi/master/gifs/Hi.gif" width="30px"> 02/03/2022 - **We are currently applying TransMorph to [MICCAI 2021 L2R challenge](https://learn2reg.grand-challenge.org/evaluation/task-3-validation/leaderboard/). It is currently ranked 2nd place on the validation set of task03 (brain MR) @ 45th epoch. After done training, we will provide the scripts and the pretrained models here: [TransMorph on OASIS](https://github.com/junyuchen245/TransMorph_Transformer_for_Medical_Image_Registration/blob/main/TransMorph_on_OASIS.md)**\
