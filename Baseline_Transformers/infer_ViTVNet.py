...
def main():
    ...
    test_dir = 'D:/DATA/IXI_brain/network_training/Test/'
    model_idx = -1
    weights = [1, 1]
    model_folder = 'ViTVNet_ncc_{}_diffusion_{}/'.format(weights[0], weights[1])
    ...
    model.cuda()
    reg_model = utils.register_model(img_size, 'bilinear').cuda()
