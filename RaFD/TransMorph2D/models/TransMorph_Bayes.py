...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, rpe=True, attn_drop=0., proj_drop=0., drop=0.):
...
CONFIGS = {
    'TransMorphBayes': configs.get_2DTransMorphBayes_config(),
}